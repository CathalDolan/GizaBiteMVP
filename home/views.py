...
def index(request):
    ...
    #     # print(record)
    #     allergen_ss_field = record["Allergens"]
    #     if allergen_ss_field != "":
    #         allergen_ss_field_split = allergen_ss_field.split(",")
    #         for item in allergen_ss_field_split:
    #             sub_allergen = item.split("/")
    #             if sub_allergen[0] not in allergen_group:
    #                 allergen_group.append(sub_allergen[0])
    #             for index, sub_allergen2 in enumerate(sub_allergen):
    #                 if index != 0:
    #                     if sub_allergen2 not in allergen:
    #                         allergen.append(sub_allergen2)
    # print(allergen_group)
    # print(allergen)
    # for y in allergen_group:
    #     x = AllergenGroup.objects.create(
    #         name=y
    #     )
    #     x.save()
    # for z in allergen:
    #     w = Allergens.objects.create(
    #         name=z
    #     )
    #     w.save()
